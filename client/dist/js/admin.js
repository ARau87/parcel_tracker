...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__settings_adminRoutes__ = __webpack_require__(73);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__pages_admin_admin_parcel__ = __webpack_require__(74);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__pages_admin_admin_dashboard__ = __webpack_require__(75);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__pages_admin_admin_home__ = __webpack_require__(76);
...
const AdminParcel = {
    ...
    methods: {
        ...
        endDelivery: function() {
            Object(__WEBPACK_IMPORTED_MODULE_1__common_methods__["d" /* endParcel */])(this.details.trackingNr).then((response) => {
                if(response.status === 200){
                    window.location.reload();
                }
            });
        ...
        getParcelDetailsAdmin: __WEBPACK_IMPORTED_MODULE_1__common_methods__["f" /* getParcelDetailsAdmin */],
    }
    ,
    computed: {
