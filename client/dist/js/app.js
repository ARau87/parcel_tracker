...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_latinize__ = __webpack_require__(33);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_latinize___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_latinize__);
...
/* harmony export (immutable) */ __webpack_exports__["c"] = checkLogin;
...
/* harmony export (immutable) */ __webpack_exports__["e"] = getParcelDetails;
...
/* harmony export (immutable) */ __webpack_exports__["f"] = getParcelDetailsAdmin;
...
/* harmony export (immutable) */ __webpack_exports__["d"] = endParcel;


const autocompletePostalCode = async function(city, address){

    __WEBPACK_IMPORTED_MODULE_1_latinize___default.a.characters['ü'] = 'ue';
    __WEBPACK_IMPORTED_MODULE_1_latinize___default.a.characters['ä'] = 'ae';
    __WEBPACK_IMPORTED_MODULE_1_latinize___default.a.characters['ö'] = 'oe';

    let response = await __WEBPACK_IMPORTED_MODULE_0_axios___default()({
        url: '/v1/api/autocomplete/postalcode?address=' +__WEBPACK_IMPORTED_MODULE_1_latinize___default()(partOfCity) + '&city=' + __WEBPACK_IMPORTED_MODULE_1_latinize___default()(city),
        method: 'get'
    });
...
/* harmony export (immutable) */ __webpack_exports__["b"] = autocompletePostalCode;


// Return a debounced version of this function
const autocompletePostalCodeD = __WEBPACK_IMPORTED_MODULE_2_underscore___default.a.debounce(autocompletePostalCode, 350);
/* unused harmony export autocompletePostalCodeD */
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__header__ = __webpack_require__(34);
...
/* harmony default export */ __webpack_exports__["a"] = ({
    ...
    methods: {
        logout: function(){
           Object(__WEBPACK_IMPORTED_MODULE_1__common_methods__["i" /* logout */])().then(() => this.$emit('logout'));
        }
    }
});
...
var canPromise = __webpack_require__(49)
...
var ECLevel = __webpack_require__(36)
var Mode = __webpack_require__(6)
var isArray = __webpack_require__(35)
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__settings_routes__ = __webpack_require__(43);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__pages_home__ = __webpack_require__(44);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__pages_login__ = __webpack_require__(45);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__pages_register__ = __webpack_require__(46);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__pages_dashboard__ = __webpack_require__(47);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__pages_parcel__ = __webpack_require__(48);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__pages_new_parcel__ = __webpack_require__(70);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__pages_parcel_created__ = __webpack_require__(71);
...
const routes = [
    ...
    {
        path: '/register',
        component: __WEBPACK_IMPORTED_MODULE_2__pages_register__["a" /* default */]
    },
    ...
    {
        path: '/new-parcel',
        component: __WEBPACK_IMPORTED_MODULE_5__pages_new_parcel__["a" /* default */]
    },
    {
        path: '/parcel/:trackingNr',
        component: __WEBPACK_IMPORTED_MODULE_4__pages_parcel__["a" /* default */]
    },
    {
        path: '/parcel/:trackingNr/created',
        component: __WEBPACK_IMPORTED_MODULE_6__pages_parcel_created__["a" /* default */]
    }
];
...
const Home = {
    ...
    methods: {
        checkLogin: __WEBPACK_IMPORTED_MODULE_0__common_methods__["c" /* checkLogin */],
        reload: __WEBPACK_IMPORTED_MODULE_0__common_methods__["j" /* reload */]
    },
    computed: {
    }
}
...
const Login = {
    ...
    methods: {
        ...
        checkLogin: __WEBPACK_IMPORTED_MODULE_1__common_methods__["c" /* checkLogin */]
    },
    computed: {
...
const Home = {
    ...
    methods: {
        checkLogin: __WEBPACK_IMPORTED_MODULE_0__common_methods__["c" /* checkLogin */],
        loadAllParcels: __WEBPACK_IMPORTED_MODULE_0__common_methods__["g" /* loadAllParcels */]
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__common_methods__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_qrcode__ = __webpack_require__(37);
...
const Parcel = {
    ...
    methods: {
        checkLogin: __WEBPACK_IMPORTED_MODULE_0__common_methods__["c" /* checkLogin */],
        getParcelDetails: __WEBPACK_IMPORTED_MODULE_0__common_methods__["e" /* getParcelDetails */],
        generateQRCode: function (trackingNr, canvasId) {
            let baseUrl = window.location.protocol + '//' + window.location.host + '/#/tracking/' + trackingNr;
            return __WEBPACK_IMPORTED_MODULE_2_qrcode___default.a.toCanvas(document.getElementById(canvasId), baseUrl);
        }
    },
    computed: {
    }
...
var getSymbolSize = __webpack_require__(5).getSymbolSize
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_axios__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_axios___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_axios__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_underscore__ = __webpack_require__(14);
...
const NewParcel = {
    ...
    watch: {
        ...
        receiverCity: function(city){
            if(this.receiverAddress.length > 0){

            }
        },
        receiverAddress: function (address) {
            if(this.receiverCity.length > 0){
                Object(__WEBPACK_IMPORTED_MODULE_0__common_methods__["b" /* autocompletePostalCode */])(this.receiverCity, this.receiverAddress).then((postalcode) => {
                    this.receiverPostcode = postalcode;
                });
            }
        }
    }
...
/* harmony default export */ __webpack_exports__["a"] = (ParcelCreated);
